  ...
  <div class="carousel-inner no-padding my-5">
    ...
    <div class="carousel-item active">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=1}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=2}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=3}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=4}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=5}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=6}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=7}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=8}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=9}" onclick=abc(this) class="slider_info">
...
<h1><b>Disney 애니메이션</b></h1>
  ...
  <div class="carousel-inner no-padding my-5">
    ...
    <div class="carousel-item active">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=145}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=146}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=147}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=148}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=149}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=150}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=151}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=152}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=153}" onclick=abc(this) class="slider_info">
...
<h1><b>인기 예능</b></h1>
  ...
  <div class="carousel-inner no-padding my-5">
    ...
    <div class="carousel-item active">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=105}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=106}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=107}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=108}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=109}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=110}" onclick=abc(this) class="slider_info">
    ...
    <div class="carousel-item">
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=111}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=112}" onclick=abc(this) class="slider_info">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4">
        <a href="/Product/productDetail?pno=${pno=113}" onclick=abc(this) class="slider_info">
...
<!-- Marketing messaging and featurettes
  ...
  <div class="container marketing">
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">	
      	<img src="resources/img/doctorstrange2.jpg" class="d-block w-100" alt="doctorstrange">
      </div>
    </div>
