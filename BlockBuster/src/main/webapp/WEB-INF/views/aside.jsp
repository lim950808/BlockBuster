...
<ul>
	<li><a href="${pageContext.request.contextPath}/CategoryList?c=1000">영화</a>
		<ul class="low">
			...
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1100">공포</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1200">액션</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1300">범죄/스릴러</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1400">전쟁</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1500">판타지/SF</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1600">코미디</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=1700">멜로/로멘스</a></li>
		</ul>
	</li>
	<li><a href="${pageContext.request.contextPath}/CategoryList?c=2000">드라마</a>
		<ul class="low">
			...
			<li><a href="${pageContext.request.contextPath}/GenreList?g=2100">미드</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=2200">일드</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=2300">한드</a></li>
		</ul>
	</li>
	<li><a href="${pageContext.request.contextPath}/CategoryList?c=3000">예능</a>
		<ul class="low">
			...
			<li><a href="${pageContext.request.contextPath}/GenreList?g=3100">KBS</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=3200">SBS</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=3300">MBC</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=3400">TVN</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=3500">JTBC</a></li>
		</ul>
	</li>
	<li><a href="${pageContext.request.contextPath}/CategoryList?c=4000">다큐</a>
		<ul class="low">
			...
			<li><a href="${pageContext.request.contextPath}/GenreList?g=4100">히스토리</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=4200">디스커버리</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=4300">내셔널 지오그래픽</a></li>
		</ul>
	</li>
	<li><a href="${pageContext.request.contextPath}/CategoryList?c=5000">애니</a>
		<ul class="low">
			...
			<li><a href="${pageContext.request.contextPath}/GenreList?g=5100">디즈니</a></li>
			<li><a href="${pageContext.request.contextPath}/GenreList?g=5200">지브리</a></li>
		</ul>
	</li>
</ul>